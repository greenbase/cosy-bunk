"""
This module reads all json files from the specified directories, parses them and writes all the data into a pandas dataframe which then is saved in csv-format.
...
# respectively
column_names=[f"force.{latte_index}.{sensor_index}" for latte_index in range(1,33) for sensor_index in range(1,3)]
